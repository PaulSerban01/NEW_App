      ...
      target.innerHTML = `
        <section class="px-4 pt-10 pb-10 sm:px-6 xl:px-8 xl:pt-16">
          <div class="max-w-md mx-auto xl:mx-0 text-center xl:text-left">
            ...
            <h1 class="mt-4 text-2xl font-bold tracking-tight text-fg sm:text-3xl">${label}</h1>
            <p class="mt-2 text-sm text-fg-muted">
              Această pagină este în pregătire. Componentele și conținutul vor fi adăugate în fazele următoare.
            </p>
            <a href="#/" class="mt-5 inline-flex items-center gap-1.5 text-sm font-semibold text-accent-text hover:underline underline-offset-2">
